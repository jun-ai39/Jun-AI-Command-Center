...
describe('EquipmentProfileContent', () => {
  it('shows equipment identity and its latest linked work reports', () => {
    ...
    expect(markup).toContain('KNOWLEDGE / STEP 95')
    ...
    expect(markup).toContain('INSPECTION RECORDS / STEP 98')
    ...
    expect(markup).toContain('GUIDE / STEP 109')
    ...
    expect(markup).toContain('KNOWLEDGE / STEP 122')
